...
namespace ServiceSupervisor {
    ...
    public class App: XAS.App.Service {
        ...
        public override String GetUsage() {
            ...
            return "Usage: xas-supervisord\n   or: xas-supervisord --help";
        ...
        public override String[] GetManual() {
            ...
            text.Add("NAME");
            text.Add("");
            text.Add("    xas-supervisord - A supervisor service");
            text.Add("");
            text.Add("SYNPOSIS");
            text.Add("");
            text.Add("    sc start xas-supervisord ");
            text.Add("");
            text.Add("    xas-supervisord [--help] [--manual] [--version]");
            text.Add("");
            text.Add("DESCRIPTION");
            text.Add("");
            text.Add("    This service provides supervisor services to the XAS environment.");
            text.Add("");
