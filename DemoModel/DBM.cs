    ...
    public class DBM: IDBM {
        ...
        public void Populate(XAS.Model.Context db) {
            ...
            List<Dinosaurs> dinosaurs = new List<Dinosaurs>() {
                new Dinosaurs { Id = 1, Name = "Kirekegarrd", HeightInFeet = 0, Status = "Defaulted" },
                new Dinosaurs { Id = 2, Name = "Voltarie", HeightInFeet = 10, Status = "Inflated" },
                new Dinosaurs { Id = 3, Name = "Plato", HeightInFeet = 6, Status = "Unknown" },
                new Dinosaurs { Id = 4, Name = "Barney", HeightInFeet = 20, Status = "Famous" }
            };
