...
namespace XAS.Core.Security {
    ...
    // taken from: http://geek.hubkey.com/2008/02/impersonating-built-in-service-account.html
    //
    // Example
    //
    ...
    public class Impersonation: IDisposable {
        ...
        /// or indirectly by a user’s code; Otherwise <c>false</c>.</param>
        /// 
    ...
    /// <summary>
    /// enum for the type of logon desired.
    /// </summary>
    /// 
    ...
    /// <summary>
    /// enum for the type of logon provider.
    /// </summary>
    /// 
    ...
    /// <summary>
    /// enum for the type of builtin user.
    /// </summary>
    /// 
